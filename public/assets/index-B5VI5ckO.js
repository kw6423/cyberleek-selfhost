    ...
    ((s.prototype.writeBigUInt64LE = R(function (e, t = 0) {
      ...
      (s.prototype.writeInt32LE = function (e, t, n) {
        return (
          (e = +e),
          (t >>>= 0),
          n || ce(this, e, t, 4, 2147483647, -2147483648),
          (this[t] = e & 255),
          (this[t + 1] = e >>> 8),
          (this[t + 2] = e >>> 16),
          (this[t + 3] = e >>> 24),
...
var oe,
  ...
  le = o(() => {
    (g(),
      ...
      (ce = Array.from({ length: 256 }, (e, t) =>
        t.toString(16).padStart(2, `0`),
      )),
      (M = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 }),
      (N = class {}));
  });
function ue(e, t, n, r) {
...
var _r,
  ...
  Sr = s((e) => {
    ...
    ((e.Constant = j),
      ...
      (e.cstr = (e) => new oe(e)),
      (e.utf8 = (e, t) => new se(e, t)),
      (e.constant = (e, t) => new j(e, t)));
  });
function Cr(e) {
...
s(() => {
  ...
  var [u] = Z.findProgramAddressSync(
      [new TextEncoder().encode(`frontend_config`)],
      n,
    ),
    d = window.__ENV__.RPC_NODES;
  function f() {
    return D([...d]);
  }
  var p,
  ...
  function w(e) {
    if (C.length !== 1626) throw Error(`Wordlist missing`);
    let t = Array.from(e)
    ...
    let r = [],
      i = C.length;
    for (let e = 0; e < 32; e += 8) {
      let t = parseInt(n.substring(e, e + 8), 16),
        a = t % i,
        o = (Math.floor(t / i) + a) % i,
        s = (Math.floor(Math.floor(t / i) / i) + o) % i;
      r.push(C[a], C[o], C[s]);
    }
    let a = ``;
    for (let e of r) a += e.substring(0, 3);
    let o = 4294967295;
    for (let e = 0; e < a.length; e++) {
      o ^= a.charCodeAt(e);
      for (let e = 0; e < 8; e++) o = (o >>> 1) ^ (3988292384 & -(o & 1));
    }
    return ((o = (o ^ 4294967295) >>> 0), r.push(r[o % 12]), r.join(` `));
  }
  function T(e) {
  ...
  async function te(e) {
    ...
    for (let e = 0; e < m.length; e++)
      if (((h = e), await O(m[e])))
        return ((g = m[e]), console.log(`[rpc] using`, g), ee(g));
    throw Error(`No reachable RPC`);
  }
  async function ne() {
    if (_) {
      for (; _; ) await new Promise((e) => setTimeout(e, 100));
      return m.length > 0;
    }
    if (((_ = !0), m.length === 0)) return ((_ = !1), !1);
        ...
        ?.addEventListener(`click`, async () => {
          ...
          if (r) {
            ...
            try {
              ...
              (await e.getSlot(), (m = [r]), (g = r), (p = e), t.remove());
              let n = document.getElementById(`custom-rpc-toggle`);
              (n && n.classList.add(`hidden`),
                T(`connecting please wait`),
                await Promise.all([N(), ue(), fe()]),
                T(`system online (custom rpc)`),
                setInterval(N, 6e4),
                setInterval(ue, 6e4),
                setInterval(fe, 15e3));
            } catch {
    ...
    for (let t = 0; t < m.length; t++)
      try {
        ...
        if (t.includes(`union`) || t.includes(`expected the value`)) {
          ...
          if (
            (console.warn(`[rpc] ${g} failed: ${e.message || e}`),
            !(await ne()))
          )
            break;
        } else if (
          (console.warn(`[rpc] ${g} failed: ${e.message || e}`), !(await ne()))
        )
          break;
      }
    return t;
  ...
  async function j(e, t, r) {
    let i = await se(async () => {
      let i = [{ memcmp: { offset: 0, bytes: e } }];
      return (
        r && i.push({ dataSize: r }),
        (await p.getProgramAccounts(n, { filters: i, encoding: `base64` }))
          .map((e) =>
            t(
  ...
  async function ce() {
    let e = await se(async () => {
      let e = await p.getAccountInfo(u);
      return e ? oe(new Uint8Array(e.data)) : null;
    }, null);
  ...
  async function N() {
    ...
    if (a.length > 0 && n.swapEnabled) {
      ...
      for (let t of a) {
        ...
        ((n.href = b(t.url.replace(/\{MINT\}/g, e))),
          (n.target = `_blank`),
          (n.rel = `noopener`),
    ...
    let o = t.sections.find((e) => e.id === `faq`);
    o && o.visible
      ? (document.getElementById(`btn-faq`)?.classList.remove(`hidden`),
        (document.getElementById(`faq-content`).innerHTML = t.faq
          .map(
            (e) =>
              `<div class="faq-q">▸ ${y(e.question)}</div><div class="faq-a">${y(e.answer)}</div>`,
          )
          .join(``)))
      : document.getElementById(`btn-faq`)?.classList.add(`hidden`);
    let s = t.sections.find((e) => e.id === `contact`),
      c = t.secure_contact;
    (c.enabled &&
      c.public_secret &&
      c.iterations > 0 &&
    ...
    let l = document.getElementById(`btn-monero-contact`);
    if (l) {
      let e = l.cloneNode(!0);
      (l.parentNode?.replaceChild(e, l),
        e.addEventListener(`click`, async () => {
          let e = document.getElementById(`intro`),
            t = document.getElementById(`monero-loading`),
            n = document.getElementById(`monero-content`);
          if (
            !c.enabled ||
            !c.public_secret ||
            !c.iterations ||
          ...
          let r = 999999999999n,
            ...
            o;
          do {
            (crypto.getRandomValues(a), (o = 0n));
            for (let e of a) o = (o << 8n) | BigInt(e);
          } while (o >= i);
          let s = String((o % r) + 1n).padStart(12, `0`),
            l = document.getElementById(`xmr-amount`),
            u = document.getElementById(`xmr-address`);
          (l && (l.textContent = c.xmr_integer_part + `.` + s),
            u && (u.textContent = c.xmr_address));
          try {
            let e = new TextEncoder(),
              r = await crypto.subtle.importKey(
                `raw`,
                e.encode(c.public_secret),
                `PBKDF2`,
                !1,
                [`deriveBits`],
              ),
              ...
              a = document.getElementById(`mnemonic`);
            (a && (a.textContent = i),
              t && (t.style.display = `none`),
              n && (n.style.display = `block`));
          } catch {
            t &&
              (t.innerHTML = `<div style="color:#f87171;">Error generating contact details.</div>`);
          }
        }));
    }
    return !0;
  ...
  async function le() {
    let e = document.getElementById(`anns`);
    if ((document.getElementById(`card-anns`), !M().announcementsEnabled))
      return !0;
    try {
      let t = await j(s, ie, 656);
      if ((t.sort((e, t) => t.timestamp - e.timestamp), !t.length))
        return (
          (e.innerHTML = `<span style="color:var(--text-dim)">none yet</span>`),
          !0
        );
      let n = t.slice(0, 3),
        r = t.slice(3),
        i = n
          .map(
            (e) => `<div class="ann-item">
         <div class="ann-date">${S(e.timestamp)}</div>
         <div class="ann-title">${y(e.title)}</div>
         <div class="ann-body">${y(e.body)}</div>
       </div>`,
          )
          .join(``);
      return (
        r.length &&
          (i += `<button class="dd-btn" onclick="this.classList.toggle('open');this.nextElementSibling.classList.toggle('show');">▸ ${r.length} older <span class="arr">▼</span></button>
            <div class="dd-body">
              ${r
                .map(
                  (e) => `<div class="ann-item">
      ...
      return (
        (e.innerHTML = `<span style="color:var(--text-dim)">announcements loading...</span>`),
        setTimeout(le, 5e3),
        !1
      );
    }
  ...
  async function ue() {
    ...
    if ((document.getElementById(`card-content`), !M().contentEnabled))
      return !0;
    try {
      let t = await j(a, re, 7156);
      return (
        ...
        <div class="content-title">${y(e.title)}</div>
        <div>
          ${e.items
            .map((e, t) => {
              let n = e.url.startsWith(`magnet:`);
              return `<a class="mirror-link ${n ? `mirror-magnet` : ``}" href="${b(e.url)}" target="_blank" rel="noopener">${n ? `🧲` : `▸`} ${y(e.label && e.label.trim() ? e.label.trim() : `Mirror ${t + 1}`)}</a>`;
            })
            .join(``)}
        </div>
      </div>`,
    ...
    try {
      ...
      for (let e = 0; e < r.choices.length; e++) {
        ...
        if ((c.push(t.toBase58()), s)) {
          ...
          (l.push(t), (u += t), t > f && ((f = t), (d = e)));
        } else
          try {
            let n = await se(() => p.getTokenAccountBalance(t), null),
              r = n ? BigInt(n.value.amount) : 0n;
            (l.push(r), (u += r), r > f && ((f = r), (d = e)));
          } catch {
            l.push(0n);
          }
      }
      ...
      ((m += i
        ...
        (m += `<div class="poll-title">${y(r.title)}</div>`));
      let h = u > 0n ? y(r.choices[d]) : `—`;
      return (
        (m += `<div class="poll-meta">${i ? `ends` : `ended`} ${S(r.endsAt)}${i ? ` · <span id="countdown"></span>` : ``} · ${x(u.toString())} $CYBERLEEK donated`),
        u > 0n &&
        ...
        r.choices.forEach((e, t) => {
          let o = u > 0n ? Number((l[t] * 10000n) / u) / 100 : 0,
            s = t === d && f > 0n;
          ((m += `<div class="choice-row ${s ? `winning` : ``}"><div class="choice-top"><span class="choice-name ${s ? `winner` : ``}">${s ? `▸ ` : ``}${y(e)}${s && !i ? ` ★` : ``}</span><span class="choice-stats">${x(l[t].toString())} <span class="pct">${o.toFixed(1)}%</span></span></div><div class="bar-track"><div class="bar-fill ${s ? `winner` : ``}" style="width:${Math.max(o, 0.5)}%"></div></div>`),
            i || (!a && n >= r.endsAt)
  ...
  async function P() {
    ...
    try {
      ((p = await te()), T(`connecting please wait`));
    } catch {
      (T(`✕ all rpcs offline`), k());
      return;
    }
    let t = await N();
    await c(3e3);
    ...
    let i = await fe();
    (t && n && r && i
      ? (T(`system online`), e && e.classList.add(`hidden`))
      : T(`connecting please wait...`),
      setInterval(N, 6e4),
      setInterval(le, 6e4),
      setInterval(ue, 6e4),
